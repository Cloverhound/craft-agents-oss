...
// Credential tools (Cloverhound custom feature)
import {
...
// Queue tools (Cloverhound custom feature)
import {
  createQueuePushTool,
...
const configValidateSchema = {
  target: z.enum(['config', 'sources', 'statuses', 'preferences', 'permissions', 'hooks', 'tool-icons', 'queue', 'all'])
