...
function AppShellContent({
  ...
  const { canGoBack, canGoForward, goBack, goForward, navigateToSource, navigateToSession, defaultViewRoute } = useNavigation()
  ...
  }), [contextValue, handleDeleteSession, sources, skills, credentials, labelConfigs, handleSessionLabelsChange, enabledModes, effectiveSessionStatuses, handleSessionSourcesChange, rightSidebarOpenButton, searchActive, searchQuery, handleChatMatchInfoChange])
  ...
  }, [activeWorkspace, onCreateSession, defaultViewRoute, focusZone])
  ...
  const unifiedSidebarItems = React.useMemo((): SidebarItem[] => {
    ...
    return result
  }, [handleAllSessionsClick, handleFlaggedClick, handleArchivedClick, handleSessionStatusClick, effectiveSessionStatuses, handleLabelClick, labelConfigs, labelTree, viewConfigs, handleViewClick, handleSourcesClick, handleCredentialsClick, handleSkillsClick, handleSettingsClick, handleWhatsNewClick, handleQueueClick, handleQueueTypeClick, queueTypes])
