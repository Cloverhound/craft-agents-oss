 ...
 * Includes only relevant items for the CloverhoundAI app.
 *
...
export async function rebuildMenu(): Promise<void> {
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    ...(isMac ? [{
      label: 'CloverhoundAI',
      submenu: [
        { role: 'about' as const, label: 'About CloverhoundAI' },
        updateMenuItem,
        ...
        { type: 'separator' as const },
        { role: 'hide' as const, label: 'Hide CloverhoundAI' },
        { role: 'hideOthers' as const },
        { role: 'unhide' as const },
        { type: 'separator' as const },
        { role: 'quit' as const, label: 'Quit CloverhoundAI' }
      ]
    }] : []),
